...
#AN070 lcd on J2 expand port
 set_location_assignment PIN_B9  -to rgb_tft[7]
 set_location_assignment PIN_A8  -to rgb_tft[6]
 set_location_assignment PIN_B8  -to rgb_tft[5]
 set_location_assignment PIN_A7  -to rgb_tft[4]
 set_location_assignment PIN_B7  -to rgb_tft[3]
 set_location_assignment PIN_A6  -to rgb_tft[2]
 set_location_assignment PIN_B6  -to rgb_tft[1]
 set_location_assignment PIN_A5  -to rgb_tft[0]
 set_location_assignment PIN_B5  -to tft_clk
 set_location_assignment PIN_A4  -to tft_de
 set_location_assignment PIN_B13 -to rgb_tft[15]
 set_location_assignment PIN_A12 -to rgb_tft[14]
 set_location_assignment PIN_B12 -to rgb_tft[13]
 set_location_assignment PIN_A11 -to rgb_tft[12]
 set_location_assignment PIN_B11 -to rgb_tft[11]
 set_location_assignment PIN_A10 -to rgb_tft[10]
 set_location_assignment PIN_B10 -to rgb_tft[9]
 set_location_assignment PIN_A9  -to rgb_tft[8]
 set_location_assignment PIN_B4  -to hsync
 set_location_assignment PIN_D8  -to rgb_tft[23]
 set_location_assignment PIN_C8  -to rgb_tft[22]
 set_location_assignment PIN_F8  -to rgb_tft[21]
 set_location_assignment PIN_E7  -to rgb_tft[20]
 set_location_assignment PIN_C6  -to rgb_tft[19]
 set_location_assignment PIN_D6  -to rgb_tft[18]
 set_location_assignment PIN_D5  -to rgb_tft[17]
 set_location_assignment PIN_A13 -to rgb_tft[16]
 set_location_assignment PIN_A3  -to vsync
 set_location_assignment PIN_C2  -to tft_pwm
#set_location_assignment PIN_B1  -to int
#set_location_assignment PIN_B3  -to scl
#set_location_assignment PIN_A2  -to sda
...
#AN706 ad7606 on J1 expand port
 set_location_assignment PIN_T11 -to ad_busy
 set_location_assignment PIN_T13 -to ad_convstab
 set_location_assignment PIN_R10 -to ad_cs
 set_location_assignment PIN_T8  -to ad_data[0]
 set_location_assignment PIN_R7  -to ad_data[1]
 set_location_assignment PIN_T7  -to ad_data[2]
 set_location_assignment PIN_R6  -to ad_data[3]
 set_location_assignment PIN_T6  -to ad_data[4]
 set_location_assignment PIN_R5  -to ad_data[5]
 set_location_assignment PIN_T5  -to ad_data[6]
 set_location_assignment PIN_R4  -to ad_data[7]
 set_location_assignment PIN_T4  -to ad_data[8]
 set_location_assignment PIN_R3  -to ad_data[9]
 set_location_assignment PIN_T3  -to ad_data[10]
 set_location_assignment PIN_P3  -to ad_data[11]
 set_location_assignment PIN_T2  -to ad_data[12]
 set_location_assignment PIN_M9  -to ad_data[13]
 set_location_assignment PIN_L10 -to ad_data[14]
 set_location_assignment PIN_L9  -to ad_data[15]
 set_location_assignment PIN_R13 -to ad_os[0]
 set_location_assignment PIN_T14 -to ad_os[1]
 set_location_assignment PIN_R12 -to ad_os[2]
 set_location_assignment PIN_T12 -to ad_rd
 set_location_assignment PIN_R11 -to ad_reset
 set_location_assignment PIN_R9  -to ad_first_data
